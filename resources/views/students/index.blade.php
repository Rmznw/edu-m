                            ...
                            <table class="table table-hover align-middle mb-0 bg-white">
                                ...
                                @foreach($students as $student)
                                    <tr class="hover-soft-bg">
                                        ...
                                        <td class="d-none d-md-table-cell text-muted">{{ $student->age }}</td>
                                        <td class="d-none d-lg-table-cell text-truncate text-secondary">{{ $student->address }}</td>
                                        <td>


                                            <a href="tel:{{ $student->phone_number }}"
                                               class="text-decoration-none link-sky">
                                                <i class="bi bi-telephone me-2"></i>{{ $student->phone_number }}
                                            </a>
                                        <td>
